...
const i18n = {
  ...
  zh: {
    ...
    indexWorks: "作品",
    indexWorksDesc: "按设计、系统与结构化工作完成的成果。",
    indexWriting: "写作",
    indexWritingDesc: "随笔、笔记与思考的文本形式。",
    indexProjects: "项目",
    indexProjectsDesc: "正在进行的系统、实验与工作。",
    indexAbout: "关于",
    indexAboutDesc: "背景、方向和系统背后的逻辑。",
    indexArchive: "归档",
    indexArchiveDesc: "为连续性和参考保留的过去资料。",
    indexApproach: "方法",
    indexApproachTitle: "随时间构建。",
    indexApproachParagraph1: "系统通过使用不断成长。随需添加、精炼或移除工作，而不追求完成。",
    indexApproachParagraph2: "重点是清晰、结构和有意义工作的积累。",
    indexEnd: "结束",
    indexClosingTitle: "一个构建\n与保存的空间。",
    indexClosingText: "结构化、安静，并开放于变化。",
    // writing.html
